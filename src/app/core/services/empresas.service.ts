...
export class EmpresasService {
  //private readonly API_URL = 'https://retodam.onrender.com/api/empresas';
  private readonly API_URL = 'https://retodam.onrender.com/api/empresas'; // Cambia esto a tu URL de API real
